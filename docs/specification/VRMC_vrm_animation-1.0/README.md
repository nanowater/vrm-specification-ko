...
- [glTF Schema Updates](#gltf-schema-updates)
  ...
  - [humanoid.humanBones](#humanoidhumanbones)
    ...
    - [humanoid.humanBones.(Humanoid 본 이름)](#humanoidhumanboneshumanoid-본-이름)
  ...
  - [expressions.preset](#expressionspreset-1)
    ...
    - [expressions.preset.(프리셋 표정 이름)](#expressionspreset프리셋-표정-이름)
  - [expressions.custom](#expressionscustom-1)
    - [Properties](#properties-6)
    - [JSON Schema](#json-schema-6)
    - [expressions.custom.(커스텀 표정 이름)](#expressionscustom커스텀-표정-이름)
