...
未定義の場合、RGB の各値は `1.0` として評価されなければなりません。
...
未定義の場合、R コンポーネントの値は `0.0` として評価されなければなりません。
...
テクスチャの値は sRGB 伝達関数でエンコードされています。
アサインされたテクスチャの RGB コンポーネントを参照し、リニア色空間に変換して評価されます。
未定義の場合、RGBの各値は `0.0` として評価されなければなりません。
...
未定義の場合、G コンポーネントの値は `1.0` として評価されなければなりません。
...
未定義の場合、B コンポーネントの値は `1.0` として評価されなければなりません。
